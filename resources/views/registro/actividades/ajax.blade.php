...
@section('contenido')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            @component('componentes.btn-create',['url'=>url('registro/actividades/create')])
            @endcomponent
    ...
    @endcomponent
    <div id="content">
        @include('registro.actividades.index')
    </div>
    <div class="loading">
...
@section('scripts')
    ...
    <script src="{{asset('js-brc/actividades/index.js')}}"></script>
@endsection
