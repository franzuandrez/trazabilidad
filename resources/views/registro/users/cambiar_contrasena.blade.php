...
@section('contenido')
    ...
    @component('componentes.nav',['operation'=>'Cambiar contraseña',
    'menu_icon'=>'fa-cogs',
    'submenu_icon'=>'fa-user',
    'operation_icon'=>'fa-retweet',])
        @slot('menu')
            Usuarios
        @endslot
        @slot('submenu')
    ...
    <div class="panel-body">
        {!!Form::model($user,['method'=>'PATCH','route'=>['users.updatePass',$user->id],'files'=> true])!!}
        {{Form::token()}}
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <input readonly type="text" name="nombre" value="{{$user->nombre}}"  class="form-control" >
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                ...
                <select  disabled name="id_rol" id= "roles" class="form-control select2" style="width: 100%;">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
                <label for="email">Contraseña Admin</label>
                <input type="password" name="admin_pass" value="{{old('password')}}"  class="form-control" >
            </div>
        </div>
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
            <div class="form-group">
