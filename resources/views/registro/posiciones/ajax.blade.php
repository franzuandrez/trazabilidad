...
@section('contenido')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            @component('componentes.btn-create',['url'=>url('registro/posiciones/create')])
            @endcomponent
    ...
    @endcomponent
    <div id="content">
        @include('registro.posiciones.index')
    </div>
    <div class="loading">
...
@section('scripts')
    ...
    <script src="{{asset('js-brc/posiciones/index.js')}}"></script>
@endsection