...
@section('contenido')
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="cant_carga_salida" id="cant_carga_salida" readonly value="{{old('cant_carga_salida')}}"
                   class="form-control ">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="cantidad_solucion_observacion" id="cantidad_solucion_observacion" readonly value="{{old('cantidad_solucion_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="ph_solucion_inicial" id="ph_solucion_inicial" value="{{old('ph_solucion_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="ph_solucion_final" id = "ph_solucion_final" readonly value="{{old('ph_solucion_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="ph_solucion_observacion" id = "ph_solucion_observacion" readonly value="{{old('ph_solucion_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="mezcla_seca_inicial" id = "mezcla_seca_inicial" value="{{old('mezcla_seca_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="ph_solucion">DATO FINAL</label>
            <input type="text" name="mezcla_seca_final" id = "mezcla_seca_final" readonly value="{{old('mezcla_seca_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="mezcla_seca_observacion"   id="mezcla_seca_observacion" readonly  value="{{old('mezcla_seca_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="mezcla_alta_inicial" id = "mezcla_alta_inicial" value="{{old('mezcla_alta_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="mezcla_alta_final"  id = "mezcla_alta_final" READONLY value="{{old('mezcla_alta_final')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="mezcla_alta_observacion" id="mezcla_alta_observacion" rEADONLY value="{{old('mezcla_alta_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="mezcla_baja_inicial" id = "mezcla_baja_inicial" value="{{old('mezcla_baja_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="mezcla_baja_final" id = "mezcla_baja_final" READONLY value="{{old('mezcla_baja_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="mezcla_baja_observacion" id="mezcla_baja_observacion"READONLY value="{{old('mezcla_baja_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="temperatura_reposo_inicial" id="temperatura_reposo_inicial" value="{{old('temperatura_reposo_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="temperatura_reposo_final" id="temperatura_reposo_final" readonly value="{{old('temperatura_reposo_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="temperatura_reposo_observacion" id="temperatura_reposo_observacion" readonly  value="{{old('temperatura_reposo_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="ancho_cartucho_inicial" id="ancho_cartucho_inicial" value="{{old('ancho_cartucho_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="ancho_cartucho_final" id="ancho_cartucho_final" readonly value="{{old('ancho_cartucho_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="ancho_cartucho_observacion" id="ancho_cartucho_observacion" readonly value="{{old('ancho_cartucho_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="temperatura_precocedora_1_inicial" id="temperatura_precocedora_1_inicial"  value="{{old('temperatura_precocedora_1_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="temperatura_precocedora_1_observacion" id="temperatura_precocedora_1_observacion" readonly=""
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="tiempo_precocedora_1_inicial"  id="tiempo_precocedora_1_inicial"  value="{{old('tiempo_precocedora_1_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="tiempo_precocedora_1_final" id="tiempo_precocedora_1_final"  readonly value="{{old('tiempo_precocedora_1_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="tiempo_precocedora_1_observacion" id="tiempo_precocedora_1_observacion"  readonly value="{{old('tiempo_precocedora_1_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="temperatura_precocedora_2_inicial" id="temperatura_precocedora_2_inicial" value="{{old('temperatura_precocedora_2_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="temperatura_precocedora_2_final" id ="temperatura_precocedora_2_final" readonly=""  value="{{old('temperatura_precocedora_2_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="temperatura_precocedora_1_observacion">OBSERVACIONES</label>
            <input type="text" name="temperatura_precocedora_2_observacion" id ="temperatura_precocedora_2_observacion" readonly=""
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="tiempo_precocedora_2_inicial" id="tiempo_precocedora_2_inicial" value="{{old('tiempo_precocedora_2_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="tiempo_precocedora_2_final" id="tiempo_precocedora_2_final" readonly value="{{old('tiempo_precocedora_2_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="tiempo_precocedora_2_observacion" id="tiempo_precocedora_2_observacion" readonly value="{{old('tiempo_precocedora_2_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="temperatura_central_inicial" id="temperatura_central_inicial"  value="{{old('temperatura_central_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="temperatura_central_final" id="temperatura_central_final" readonly value="{{old('temperatura_central_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="velocidad_pass200_inicial" id="velocidad_pass200_inicial" value="{{old('velocidad_pass200_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="velocidad_pass200_final" id="velocidad_pass200_final" readonly value="{{old('velocidad_pass200_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="velocidad_pass200_observaciones" id="velocidad_pass200_observaciones" readonly value="{{old('velocidad_pass200_observaciones')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="velocidad_pasc180_inicial" id="velocidad_pasc180_inicial" value="{{old('velocidad_pasc180_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="velocidad_pasc180_final" id="velocidad_pasc180_final"  readonly value="{{old('velocidad_pasc180_final')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="velocidad_pasc180_observaciones" id="velocidad_pasc180_observaciones" readonly value="{{old('velocidad_pasc180_observaciones')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="velocidad_pask180_inicial" id="velocidad_pask180_inicial" value="{{old('velocidad_pask180_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="velocidad_pask180_final" id="velocidad_pask180_final" readonly value="{{old('velocidad_pask180_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="velocidad_pask180_observaciones" id="velocidad_pask180_observaciones" readonly value="{{old('velocidad_pask180_observaciones')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="velocidad_pasi180_inicial" id="velocidad_pasi180_inicial" value="{{old('velocidad_pasi180_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="velocidad_pasi180_final" id="velocidad_pasi180_final" value="{{old('velocidad_pasi180_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="velocidad_pasi180_observaciones" id="velocidad_pasi180_observaciones" readonly value="{{old('velocidad_pasi180_observaciones')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <input type="text" name="velocidad_pasm160_inicial" id="velocidad_pasm160_inicial" value="{{old('velocidad_pasm160_inicial')}}"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <input type="text" name="velocidad_pasm160_final" id="velocidad_pasm160_final" readonly value="{{old('velocidad_pasm160_final')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="velocidad_pasm160_observaciones" id="velocidad_pasm160_observaciones" readonly="" value="{{old('velocidad_pasm160_observaciones')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <select class="form-control selectpicker" data-live-search="true" id="extractor_activo_inicial" name="extractor_activo_inicial"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <select class="form-control selectpicker" data-live-search="true" id="extractor_activo_final"  DISABLED name="extractor_activo_final">
                <option  value="" selected>SELECCIONE UNA OPCION</option>
                <option value="SI">SI</option>
                <option value="NO">NO</option>
            </select>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="extractor_activo_observacion" id="extractor_activo_observacion" readonly value="{{old('extractor_activo_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_inicial">DATO INICIAL</label>
            <select class="form-control selectpicker" data-live-search="true" id="ventilacion_inicial" name="ventilacion_inicial"
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="dato_final">DATO FINAL</label>
            <select class="form-control selectpicker" data-live-search="true" id="ventilacion_final"  DISABLED name="ventilacion_final">
                <option  value="" selected>SELECCIONE UNA OPCION</option>
                <option value="SI">SI</option>
                <option value="NO">NO</option>
            </select>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            <label for="extractor_activo_observaciones">OBSERVACIONES</label>
            <input type="text" name="ventilacion_observacion" id="ventilacion_observacion" readonly value="{{old('ventilacion_observacion')}}"
                   class="form-control">
        </div>
    </div>
    ...
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="verificacion_codificacion_lote" id="verificacion_codificacion_lote"  value="{{old('verificacion_codificacion_lote')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="verificacion_codificacion_vence" id="verificacion_codificacion_vence" readonly value="{{old('verificacion_codificacion_vence')}}"
                   class="form-control">
        </div>
    </div>
    <div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
        <div class="form-group">
            ...
            <input type="text" name="verificacion_codificacion_obs" id="verificacion_codificacion_obs" readonly value="{{old('verificacion_codificacion_obs')}}"
                   class="form-control">
        </div>
    </div>
...
-->
    ...
    <div class="col-lg-3 col-sm-3 col-md-3 col-xs-12">
        <div class="form-group">
            <label for="extractor_activo_observaciones">OBSERVACIONES</label>
            <input type="text" name="sellos_observaciones" id="sellos_observaciones"  value="{{old('sellos_observaciones')}}"
                   class="form-control">
        </div>
    </div>
